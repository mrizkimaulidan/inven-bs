<!-- Modal -->
<div class="modal fade" id="department_edit_modal" data-backdrop="static" data-keyboard="false"
	tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="staticBackdropLabel">Ubah Data Prodi</h5>
			...
			<div class="modal-body">
				<form method="POST">
					...
					<div class="row">
						...
						<div class="col-lg-12">
							<div class="form-group">
								<label for="description">Deskripsi Prodi</label>
