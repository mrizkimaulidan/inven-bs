					...
					<div class="row">
						<div class="col-lg-12">
							<div class="form-group">
								<label for="name">Nama Prodi<span class="font-weight-bold text-danger">*</span></label>
						...
						<div class="col-lg-12">
							<div class="form-group">
								<label for="description">Deskripsi Prodi <span class="font-italic">(opsional)</span></label>
